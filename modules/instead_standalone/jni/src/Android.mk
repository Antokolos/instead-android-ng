...
LOCAL_SRC_FILES := instead_launcher.cpp $(SDL_PATH)/src/main/android/SDL_android_main.c \
	...
	$(SUBDIR)/SDL2_rotozoom.c $(SUBDIR)/SDL_anigif.c $(SUBDIR)/SDL_gfxBlitFunc.c $(SUBDIR)/noise1234.c
...
LOCAL_H_FILES := $(INSTEAD)/cache.h $(INSTEAD)/instead.h $(INSTEAD)/list.h $(INSTEAD)/snprintf.h $(INSTEAD)/tinymt32.h $(INSTEAD)/idf.h $(INSTEAD)/system.h $(INSTEAD)/util.h \
	...
	$(SUBDIR)/SDL2_rotozoom.h $(SUBDIR)/SDL_anigif.h $(SUBDIR)/SDL_gfxBlitFunc.h \
	$(SUBDIR)/android.h $(SUBDIR)/noise1234.h

#	$(SUBDIR)/SDL_rotozoom.c $(SUBDIR)/wince.c $(SUBDIR)/s60.c $(SUBDIR)/windows.c $(SUBDIR)/iowin32.c $(SUBDIR)/symbian.cpp \
#	$(SUBDIR)/SDL_rotozoom.h $(SUBDIR)/iowin32.h $(SUBDIR)/ios.h $(SUBDIR)/s60.h $(SUBDIR)/wince.h \
...
LOCAL_CFLAGS += -DVERSION=\"3.2.1\" -DANDROID -DNOMAIN -D_USE_SDL -D_LOCAL_APPDATA -D_HAVE_ICONV -DSDL_JAVA_PACKAGE_PATH=$(SDL_JAVA_PACKAGE_PATH) -D_CUR_DIR=$(DATAPATH)
